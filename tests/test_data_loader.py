...
class TestDataLoader:
    ...
    @patch('modules.data_loader._fetch_fred_series')
    def test_load_fred_data_success(self, mock_fetch_fred_series, mock_cache):
        ...
        mock_fetch_fred_series.return_value = mock_df
        ...
        mock_fetch_fred_series.assert_called_once_with('A191RL1Q225SBEA', start='2000-01-01')

    @patch('modules.data_loader._load_cached_data', return_value=None)
    @patch('modules.data_loader._fetch_fred_series')
    def test_load_fred_data_failure(self, mock_fetch_fred_series, mock_cache):
        """Test FRED data loading failure."""
        mock_fetch_fred_series.side_effect = Exception("API Error")
    ...
    @patch('modules.data_loader._load_cached_data', return_value=None)
    @patch('modules.data_loader._fetch_fred_series')
    def test_get_latest_value_success(self, mock_fetch_fred_series, mock_cache):
    ...
    @patch('modules.data_loader._load_cached_data', return_value=None)
    @patch('modules.data_loader._fetch_fred_series')
    def test_get_latest_value_no_data(self, mock_fetch_fred_series, mock_cache):
    ...
    @patch('modules.data_loader._load_cached_data', return_value=None)
    @patch('modules.data_loader._fetch_fred_series')
    def test_calculate_percentage_change_success(self, mock_fetch_fred_series, mock_cache):
