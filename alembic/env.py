...
# Import our SQLAlchemy models so Alembic can detect them
...
def get_database_url() -> str:
    """Construct database URL from env vars or use explicit ALEMBIC_DATABASE_URL."""
    if url := os.getenv("ALEMBIC_DATABASE_URL"):
        return url
    # Default to PostgreSQL using standard env vars
    host = os.getenv("POSTGRES_HOST", "localhost")
    port = os.getenv("POSTGRES_PORT", "5432")
    db = os.getenv("POSTGRES_DB", "economic_dashboard")
